...
class HeadApi extends BladeApi {
    getCell(i) {
        return this.controller.valueController.cellsApis[i];
    }
}
// Custom controller class should implement `Controller` interface
class TableHeadController {
    constructor(doc, config, headersParams) {
...
const className1$1 = ClassName('table');
const className2$1 = ClassName('head');
// Custom view class should implement `View` interface
class HeadView {
    constructor(doc, config) {
        // Create a root element for the plugin
        this.element = doc.createElement('div');
        this.element.classList.add(className1$1(), className2$1());
        // Bind view props to the element
        config.viewProps.bindClassModifiers(this.element);
    }
}

const tableHeadPlugin = (function () {
    return {
        id: 'tableHeadPlugin',
        type: 'blade',
        core: VERSION,
        ...
        //css: '.tp-tablev .tp-rotv{box-shadow:none}.tp-tablev .tp-brkv{display:flex;flex-direction:row;flex-wrap:nowrap;width:-moz-fit-content;width:fit-content;background-color:rgba(0,0,0,0)}.tp-tablev .tp-rotv_c{margin-top:0px;width:100%}.tp-tablev .tp-rotv_c>*{margin-top:0px}.tp-tablev .tp-lblv{padding-left:0px;float:left}.tp-tablev .tp-lblv.tp-v-lst{padding-right:0px}.tp-rowv .tp-lblv_l{display:none}.tp-headv .tp-lblv_v{display:none}.tp-tablev .tp-lblv_v{min-width:auto;flex:1}.tp-tablev .tp-rotv.tp-rotv-expanded .tp-rotv_c,.tp-tablev .tp-fldv.tp-fldv-expanded>.tp-fldv_c{padding-bottom:0px;padding-top:0px}',
        accept(params) {
            const result = parseRecord(params, (p) => ({
                view: p.required.constant('tableHead'),
                label: p.required.string,
                headers: p.required.array(p.required.object({
                    label: p.required.string,
...
class RowApi extends BladeApi {
    getCell(i) {
        return this.controller.valueController.cells.children[i];
    }
    getPane() {
        return this.controller.valueController.cells;
    }
}
class RowPane extends Pane {
    addBinding(object, key, opt_params) {
        const api = super.addBinding(object, key, opt_params);
        if (opt_params === null || opt_params === void 0 ? void 0 : opt_params.width) {
    ...
    return {
        ...
        accept(params) {
            const result = parseRecord(params, (p) => ({
                ...
                label: p.optional.string,
                cells: p.optional.array(p.required.custom((param) => {
        ...
        controller(args) {
            const LC = new LabelController(args.document, {
                blade: args.blade,
                props: ValueMap.fromObject({
                    label: args.params.label,
                }),
        ...
        api(args) {
            ...
            if (!args.controller.blade) {
                //throw new Error('Blade is not defined in args');
                console.log("No controller.blade in args:");
                console.log(args.controller);
            }
...
/* import {tableRowPlugin} from './row.js';
export * from "./row.js";

// The identifier of the plugin bundle.
export const id = 'tableRowplugin';

// This plugin template injects a compiled CSS by @rollup/plugin-replace
// See rollup.config.js for details
export const css = '.tp-tablev .tp-rotv{box-shadow:none}.tp-tablev .tp-brkv{display:flex;flex-direction:row;flex-wrap:nowrap;width:-moz-fit-content;width:fit-content;background-color:rgba(0,0,0,0)}.tp-tablev .tp-rotv_c{margin-top:0px;width:100%}.tp-tablev .tp-rotv_c>*{margin-top:0px}.tp-tablev .tp-lblv{padding-left:0px;float:left}.tp-tablev .tp-lblv.tp-v-lst{padding-right:0px}.tp-rowv .tp-lblv_l{display:none}.tp-headv .tp-lblv_v{display:none}.tp-tablev .tp-lblv_v{min-width:auto;flex:1}.tp-tablev .tp-rotv.tp-rotv-expanded .tp-rotv_c,.tp-tablev .tp-fldv.tp-fldv-expanded>.tp-fldv_c{padding-bottom:0px;padding-top:0px}';

// Export your plugin(s) as a constant `plugins`
export const plugins = [tableRowPlugin];

 */
const id = "tablePlugin";
const css = '.tp-tablev .tp-rotv{box-shadow:none}.tp-tablev .tp-brkv{display:flex;flex-direction:row;flex-wrap:nowrap;width:-moz-fit-content;width:fit-content;background-color:rgba(0,0,0,0)}.tp-tablev .tp-rotv_c{margin-top:0px;width:100%}.tp-tablev .tp-rotv_c>*{margin-top:0px}.tp-tablev .tp-lblv{padding-left:0px;float:left}.tp-tablev .tp-lblv.tp-v-lst{padding-right:0px}.tp-rowv .tp-lblv_l{display:none}.tp-headv .tp-lblv_v{display:none}.tp-tablev .tp-lblv_v{min-width:auto;flex:1}.tp-tablev .tp-rotv.tp-rotv-expanded .tp-rotv_c,.tp-tablev .tp-fldv.tp-fldv-expanded>.tp-fldv_c{padding-bottom:0px;padding-top:0px}';
// Export your plugin(s) as constant `plugins`
const plugins = [tableHeadPlugin, tableRowPlugin];

export { HeadApi, HeadView, RowApi, RowController, RowView, TableHeadController, css, id, plugins, tableHeadPlugin, tableRowPlugin };
