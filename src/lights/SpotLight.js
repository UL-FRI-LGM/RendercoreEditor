...
export class SpotLight extends Light {
    ...
    constructor(args = {}) {
		...
		this.direction = (args.direction !== undefined) ? args.direction : SpotLight.DEFAULT.DIRECTION;

        this.innerCutoff = (args.innerCutoff !== undefined) ? args.innerCutoff : SpotLight.DEFAULT.INNER_CUTOFF;
        this.outerCutoff = (args.outerCutoff !== undefined) ? args.outerCutoff : this.innerCutoff * 1.1;
    }
