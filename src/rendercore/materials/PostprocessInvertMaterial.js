...
export class PostprocessInvertMaterial extends MeshMaterial {
	...
	static DEFAULT = {
		...
		MODE: PostprocessInvertMaterial.MDOE.REINHARD,
		GAMMA: 2.2,
		EXPOSURE: 1.0,
	};
		...
		super(
			{
				...
				shaderPath: PostprocessInvertMaterial.DEFAULT.SHADER_PATH,
				programName: PostprocessInvertMaterial.DEFAULT.PROGRAM_NAME,
