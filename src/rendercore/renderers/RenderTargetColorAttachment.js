export class RenderTargetColorAttachment {
	...
	constructor(args = {}) {
		...
		this.screen = args.screen !== undefined ? args.screen : undefined;
	...
	set screen(screen) { this.#screen = screen; }
		...
		return new RenderTargetColorAttachment(
			{
				...
				screen: (this.screen === Object(this.screen)) ? this.screen.clone() : this.screen,
