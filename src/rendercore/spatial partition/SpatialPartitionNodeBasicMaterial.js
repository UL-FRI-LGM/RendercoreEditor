...
export class SpatialPartitionNodeBasicMaterial extends BoxBasicMaterial {
	...
	static DEFAULT = {
		...
		INSTRUCTION_CACHE: new InstructionCache(
			{ name: "spatial partition node basic material instruction cache" },
			[
		...
		super(
			{
				...
				resourcePack: (args.resourcePack !== undefined) ? args.resourcePack : new ResourcePack({ name: "RP - SPATIAL PARTITION NODE BASIC MATERIAL" }),
