...
export class CellPartitionBasicMaterial extends SpatialPartitionBasicMaterial {
	...
	static DEFAULT = {
		...
		INSTRUCTION_CACHE: new InstructionCache(
			{ name: "IC - CELL PARTITION BASIC MATERIAL" },
			[
		...
		super(
			{
				...
				shaderPath: (args.shaderPath !== undefined) ? args.shaderPath : CellPartitionBasicMaterial.DEFAULT.SHADER_PATH,
				programName: (args.programName !== undefined) ? args.programName : CellPartitionBasicMaterial.DEFAULT.PROGRAM_NAME,
