		...
		return super.createIndicesArrayBuffer(
			{
				...
				baseGeometry: (args.baseGeometry !== undefined) ? GridPartitionNodeGeometry.#convertBaseGeometry(args.baseGeometry) : SpatialPartitionNodeGeometry.DEFAULT.BASE_GEOMETRY,
			}
		);
	}
