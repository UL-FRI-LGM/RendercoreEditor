...
export class GridPartitionNodeBasicMaterial extends SpatialPartitionNodeBasicMaterial {
	...
	static DEFAULT = {
		...
		INSTRUCTION_CACHE: new InstructionCache(
			{ name: "IC - GRID PARTITION NODE BASIC MATERIAL" },
			[
		...
		super(
			{
				...
				shaderPath: (args.shaderPath !== undefined) ? args.shaderPath : GridPartitionNodeBasicMaterial.DEFAULT.SHADER_PATH,
				programName: (args.programName !== undefined) ? args.programName : GridPartitionNodeBasicMaterial.DEFAULT.PROGRAM_NAME,
