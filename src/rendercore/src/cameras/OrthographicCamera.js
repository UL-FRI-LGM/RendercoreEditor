...
export class OrthographicCamera extends Camera {
	static DEFAULT = {
		...
		RESOURCE_PACK: new ResourcePack({ name: "RP - ORTHOGRAPHIC CAMERA" }),
		INSTRUCTION_CACHE: new InstructionCache(
			{ name: "IC - ORTHOGRAPHIC CAMERA" },
			[
				...Camera.DEFAULT.INSTRUCTION_CACHE.clone(),
			]
		),
		DIRTY_CACHE: new MapT2(
			{ name: "DC - ORTHOGRAPHIC CAMERA" },
			[
		...
		super(
			{
				...
				resourcePack: (args.resourcePack !== undefined) ? args.resourcePack : OrthographicCamera.DEFAULT.RESOURCE_PACK.clone(),
				instructionCache: (args.instructionCache !== undefined) ? args.instructionCache : OrthographicCamera.DEFAULT.INSTRUCTION_CACHE.clone(),
				dirtyCache: (args.dirtyCache !== undefined) ? args.dirtyCache : OrthographicCamera.DEFAULT.DIRTY_CACHE.clone(),
			}
		);
