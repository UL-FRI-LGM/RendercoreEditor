...
import { BoundingSphereFrame, BoundingSphereFrameGeometry, BoundingSphereFrameBasicMaterial, BoundingSphereFrameBaseGeometry, BoundingSphereFrameBaseGeometryElement, BoundingBoxFrameBaseGeometry, BoundingBoxFrameBaseGeometryElement } from "../../RenderCore.js";
		...
		return new BoundingSphereFrame(
			{
				geometry: new BoundingSphereFrameGeometry(
					{
						indexed: false,
						baseGeometry: new BoundingSphereFrameBaseGeometry(
							{
								elements: [
		...
		return new BoundingBoxFrame(
			{
				geometry: new BoundingBoxFrameGeometry(
					{
						indexed: false,
						baseGeometry: new BoundingBoxFrameBaseGeometry(
							{
								elements: [
