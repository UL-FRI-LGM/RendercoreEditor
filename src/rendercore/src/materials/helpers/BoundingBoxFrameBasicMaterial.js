		...
		super(
			{
				...
				shaderPath: (args.shaderPath !== undefined) ? args.shaderPath : BoundingBoxFrameBasicMaterial.DEFAULT.SHADER_PATH,
				programName: (args.programName !== undefined) ? args.programName : BoundingBoxFrameBasicMaterial.DEFAULT.PROGRAM_NAME,
