...
export class MeshLambertMaterial extends MeshMaterial {
	...
	static DEFAULT = {
		...
		INSTRUCTION_CACHE: new InstructionCache(
			{ name: "IC - MESH LAMBERT MATERIAL" },
			[
				...MeshMaterial.DEFAULT.INSTRUCTION_CACHE.clone(),
			]
		),

		SHADER_PATH: "/src/rendercore/src/shaders/lambert/",
		...
		super(
			{
				...
				instructionCache: (args.instructionCache !== undefined) ? args.instructionCache : MeshLambertMaterial.DEFAULT.INSTRUCTION_CACHE.clone(),

				shaderPath: (args.shaderPath !== undefined) ? args.shaderPath : MeshLambertMaterial.DEFAULT.SHADER_PATH,
				programName: (args.programName !== undefined) ? args.programName : MeshLambertMaterial.DEFAULT.PROGRAM_NAME,
